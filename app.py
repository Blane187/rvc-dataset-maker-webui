...
def download_and_process(dataset, mode, url, drive_path, audio_name):
    ...
    if dataset == "Drive":
        ...
        result_text += f"Downloaded audio from YouTube to youtubeaudio/{audio_name}.wav\n"
    ...
    if dataset == "Youtube":
        os.system(f'cp -r /content/separated/htdemucs/{audio_name}/* /content/drive/MyDrive/audio/{audio_name}')
        os.system(f'cp -r youtubeaudio/{audio_name}.wav /content/drive/MyDrive/audio/{audio_name}')
    ...
    if mode == "Separate":
        ...
        os.system(f'cp -r dataset/{audio_name}/* /content/drive/MyDrive/dataset/{audio_name}')
        
        result_text += f"Audio files have been split and saved to dataset/{audio_name}\n"
...
with gr.Blocks(title="RVCDMFGC") as demo:
    ...
    submit.click(process, inputs=[dataset, mode, url, drive_path, audio_name], outputs=output)
