...
with gr.Blocks(title="rvc dataset maker webui") as demo:
        ...
        with gr.TabItem("make dataset"):
            with gr.Row():
                url_input = gr.Textbox(
                    label="YouTube URL",
                    value="https://youtu.be/ZdoiTX1f1tU?si=hZ96tryqaPIYfwg1",
                )
            with gr.Row():
            ...
            with gr.Row():
                ...
                run_button.click(
                    fn=process_audio,
                    inputs=[url_input, audio_name_input],
                    outputs=[result_output],
                )
                push_hub.click(
                    fn=push_to_hub,
                    inputs=[result_output, hf_token_input, repo_id_input],
    ...
    with gr.Tabs():
        gr.Markdown(
            f"### <div style='text-align: center;'>made with ❤ by <a href='https://huggingface.co/Hev832'>Hev832</a></div>"
        )
